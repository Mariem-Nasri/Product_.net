    ...
    public class ProductController : ControllerBase
    {
        ...
        public async Task<ActionResult> Add(AddProductCommandNew cmd)
        {
            try
            {
                ...
                AddCustomerResult = validator.Validate(new ValidationContext<AddProductCommandNew>(cmd));
        ...
        public async Task<ActionResult> Update([FromBody] UpdateProductCommandNew cmd)
        {
            try
            {
                ...
                updateCustomerResult = validator.Validate(new ValidationContext<UpdateProductCommandNew>(cmd));
